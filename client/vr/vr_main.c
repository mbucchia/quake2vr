...
void VR_Startup(void)
{
	...
	vr_hud_deadzone_yaw = Cvar_Get("vr_hud_deadzone_yaw","20",CVAR_CLIENT);
	vr_hud_fixed = Cvar_Get("vr_hud_fixed","1",CVAR_CLIENT);
	vr_hud_bounce = Cvar_Get("vr_hud_bounce","2",CVAR_CLIENT);
	...
	vr_autoipd = Cvar_Get("vr_autoipd","1",CVAR_CLIENT);
